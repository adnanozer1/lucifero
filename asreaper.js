...
client.on('message', async (message) => {
    if (message.content.startsWith('.yardım')) {
        ...
        .setStyle('url')
        .setLabel('Davet')
        .setURL('https://discord.com/api/oauth2/authorize?client_id=951549636957593700&permissions=8&scope=bot')
...
client.on('clickButton', async (button) => {
  if (button.id === 'buton1') {
    button.channel.send(`> • .kullanıcı: **Kullanıcı yardım menüsünü gösterir.**\n > • .moderasyon: **Moderasyon yardım menüsünü gösterir.**\n > • .kayıt-s: ** Kayıt sistemi yardım menüsünü gösterir.**\n > • .koruma-s:** Koruma sistemi yardım menüsünü gösterir.**\n > • .logo-s: ** Logo sistemi yardım menüsünü gösterir.**\n > • .çekiliş-s: ** Çekiliş sistemi yardım menüsünü gösterir.**\n > • .özeloda-s: ** Özel Oda sistemi yardım menüsünü gösterir.** \n > • .profil-s: **Profila sistemi yardım menüsünü gösterir.** \n > • .ekonomi-s: ** Ekonomi sistemi yardım menüsünü gösterir.**  \n > • .radyo: ** Radyo sistemi yardım menüsünü gösterir.** \n > • .müzikyardım: ** Müzik Sistemini Gösteir!**`);
  }
    if (button.id === 'buton2()') {
      button.channel.send(`||https://discord.com/api/oauth2/authorize?client_id=907344275765874708&permissions=8&scope=bot||`)
  }
});
